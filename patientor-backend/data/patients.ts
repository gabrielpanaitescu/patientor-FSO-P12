...
// import { PatientDataSchema } from "../src/utils/newPatient";
...
// export const patientData: Patient[] = data.map((object) => {
//   const patient = PatientDataSchema.parse(object) as Patient;
//   console.log(patient);
